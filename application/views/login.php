                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-primary">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul>
                                        <li><b>NIP/NIM</b> diisi dengan NIP/NIM yang dosen/mahasiswa pakai</li>
                                        <li>Jika lupa password gunakan, <a href="#">I forgot my password</a>. kemudian masukkan <b>e-mail Anda</b></li>
                                        <li>Jika mengalami <b>permasalahan</b> dapat mengirimkan ke <b>11651104372@students-uin-suska.ac.id</b> dengan menyebutkan permasalahan Subjek e-mail serta menyebutkan nim, nama, program studi, dan deskripsi permasalahan pada isi e-mail</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <ul class="timeline">
                                        <li>
                                            ...
                                            <div class="timeline-panel">
                                                <div class="timeline-heading">
                                                    <h5 class="timeline-title"><b>Login Dosen/Mahasiswa</b></h5>
                                                </div>
                                                <div class="timeline-body">
                                                    <small>Dosen/Mahasiswa Terlebih dahulu login</small>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="timeline-inverted">
                                            ...
                                            <div class="timeline-panel">
                                                ...
                                                <div class="timeline-body">
                                                    <small>Dosen/Mahasiswa Mengisi form kuesioner</small>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
