<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="<?php echo base_url('int/users/index') ?>"><i class="fa fa-user fa-fw"></i> User</a>
            </li>
            <li>
                <a href="<?php echo base_url('int/kuesioner/index') ?>"><i class="fa fa-list fa-fw"></i> Kuesioner</a>
            </li>
            <li>
                <a href="<?php echo base_url('int/alumni/index') ?>"><i class="fa fa-user fa-fw"></i> Alumni</a>
            </li>
            <li>
                <a href="<?php echo base_url('int/dosen/index') ?>"><i class="fa fa-user fa-fw"></i> Dosen</a>
            </li>
        <li>
