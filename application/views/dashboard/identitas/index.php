                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $row['nama']; ?>"><?php echo $row['nama']; ?></a></td>
                                            ...
                                            <td><a href="#" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i> Hapus</a> <a href="#" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Ubah</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                </table>
